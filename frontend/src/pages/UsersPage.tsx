  ...
  return (
    <div className="users-page">
      ...
      {selectedUser && createPortal(
        <div className="user-drawer-overlay" onClick={closeDrawer}>
          <div className="user-logs-drawer" role="dialog" aria-label="Dettaglio utente" onClick={e => e.stopPropagation()}>
            <div className="drawer-header">
              ...
              <button className="modal-close-btn" onClick={closeDrawer} aria-label="Chiudi">
